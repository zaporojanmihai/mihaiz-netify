...
function initialize_contact_map_text_map() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(44.211443, 28.604738),
    ...
    var contentString = '<div id="content"> I am here!<br>Heyya! </div>';
    ...
    var myLatLng = new google.maps.LatLng(44.211443, 28.604738);
    ...
    var customMapType = new google.maps.StyledMapType(nightOpts, styledMapOptions);
